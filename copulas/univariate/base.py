...
class Univariate(object):
    ...
    def fit(self, X):
        ...
        # self._instance = select_univariate(selection_sample, self.candidates, return_names=False)
        
        self._instance, self.names = select_univariate(selection_sample, self.candidates, return_names=True)
